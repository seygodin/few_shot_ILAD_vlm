...
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        self.visual = _build_vision_tower(args, embed_dim, vision_cfg, quick_gelu, cast_dtype)
    ...
    def encode_text(self, text, normalize: bool = False):
        #print(f"Input text to text-encoder: {text.shape}")
        cast_dtype = self.transformer.get_cast_dtype()

        x = self.token_embedding(text).to(cast_dtype)  # [batch_size, n_ctx, d_model]
        #print(f"Input text after pos-emb: {x.shape}")
