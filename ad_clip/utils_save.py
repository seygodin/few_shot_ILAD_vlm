...
object_names_breakfast = ["mandarins", "peach", "almonds", "banana chips", "oat cereal"]
...
negative_rules_for_breakfast = [
    [   "There must not be exactly two mandarins on the left.",
        "There should be more than two mandarins on the left.",
        "It is not necessary to have two mandarins on the left.",
        "There should be fewer than two mandarins on the left.",
        "It is not required to place mandarins specifically on the left."],
    ['There must not be a peach on the left.', 
     'There should be no peaches placed on the left.', 
     'It is not necessary to have a peach on the left.', 
     'A peach must be located somewhere other than the left.', 
     'The top left should contain a fruit other than a peach.'],

    ['There must not be oat cereal on the top right.', 
      'It is not necessary to have oat cereal on the top right.', 
      'oat Cereal should not be placed exclusively on the top right.', 
      'There should be no oat cereal located on the top right.', 
      'The top right should contain something other than oat cereal.'],
    ['There must not be almonds down the right.',
       'It is not necessary for almonds to be placed down the right.',
       'There should be no almonds located down the right.',
        'Almonds must be positioned somewhere other than down the right.',
       'Down the right should contain items other than almonds.'],
       
    [' There must not be banana chips down the right.', 
     ' It is not necessary to place banana chips down the right.', 
     ' There should be no banana chips located down the right.', 
     ' Banana chips must be placed somewhere other than down the right.', 
     ' Down the right should contain something other than banana chips.'],
    ...
    ['The amount of banana chips and almonds should not be the same.', 
    'It is not necessary for the quantities of banana chips and almonds to be equal.', 
    'There should be more banana chips than almonds.', 
    'There should be fewer banana chips than almonds.', 
    'The proportion of banana chips to almonds does not need to be balanced.'],
        """
